...
LLM 운영 로그를 고객·기능·모델·플랜·세션 단위 원가로 재분류하고, AI SaaS의 마진과 가격정책 판단으로 연결하는 워크스페이스입니다.

이 제품이 답하려는 핵심 질문은 "우리 AI 기능은 고객별·기능별·플랜별로 얼마의 원가를 만들고, 어떤 고객·기능·플랜이 마진을 깨고 있는가?"입니다.
...
2026-05-01,req_001,acme,enterprise,rag_chat,claude-sonnet-4.6,sess_101,run_001,1200,450,0.010,1800,success
2026-05-01,req_002,globex,pro,summary,gemini-3.1-flash,sess_102,run_002,3000,800,0.004,900,success
```
...
가져온 로그에서 Group A entry point를 먼저 요약합니다.
...
Core Engine은 비용을 여러 기준으로 다시 묶습니다.
...
### Phase 3. Research-Gated Alert / Margin Guard
