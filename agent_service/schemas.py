...
class AgentRunInput(BaseModel):
    ...
    usageLog: list[dict[str, Any]] = Field(default_factory=list)
    providerModelPriceRefs: list[dict[str, Any]] = Field(default_factory=list)
    costAttribution: dict[str, Any] = Field(default_factory=dict)
    marginProfitability: dict[str, Any] = Field(default_factory=dict)
    optimizationWhatIfSavings: list[dict[str, Any]] = Field(default_factory=list)
